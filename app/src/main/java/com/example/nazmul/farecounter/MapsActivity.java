...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,PlaceSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent directions=new Intent(MapsActivity.this,MapActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        getDeviceLocation();
        //LocTrack locTrack=new LocTrack();
    }
...
//    //Thread By Tuhin.....
//
//     class LocTrack implements Runnable{
//        Thread t;
//        LocTrack(){
//            t = new Thread(this, "LocTrack");
//            t.start();
//        }
//        public void run(){
//            int n=0;
...
//                //getDeviceLocation();
//                try {
////                    Toast.makeText(getBaseContext(),""+n,
